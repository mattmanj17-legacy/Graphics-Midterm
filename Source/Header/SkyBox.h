...
public:
	...
	void init_shader() 
	{
		program  = InitShader("glsl/Skybox_vshader.glsl", "glsl/Skybox_fshader.glsl");
		GL_CHECK_ERRORS
	...
	{		
		start_shader();
	        ...
	        glUniformMatrix4fv(uniforms[0], 1, GL_TRUE, Camera::GetInstance()->GetCameraMatrix() * Scale(50.0, 50.0, 50.0));
			GL_CHECK_ERRORS
